...
const token0 = BigNumber.from("100000000000000000000000") // Example token0 value (1 ETH in wei)
const token1 = BigNumber.from("1000000000000000000000000") // Example token1 value (0.5 ETH in wei)
